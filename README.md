...
"움직이는 person만이 넘어질 수 있다 (로베르토 고이주에타).",
...
"고백한 죄의 반은 용서 받은 것이다 (영국 속담).",
"금은 진흙 속에 있어도 금이다 (영국 속담).",
"말이 만든 상처는 칼로 입은 상처보다 깊고 심하다 (모로코 속담).",
"짖는 개를 두려워 말고 짖지 않는 개를 두려워하라 (터키 속담).",
"피는 피로써 씻을 수 없다 (페르시아 속담).",
...
"사랑은 일에 굴복한다 (만일 사랑으로부터 빠져 나오기를 원한다면 바쁘게 되라, 오비디우스).",
...
"굶주린 사람에게 배고픔의 고통을 참아야 한다는 충고를 대식가가 어찌 진지하게 얘기할 수 있겠는가 (칼릴 지브란).",
...
"햇빛은 하나의 초점에 모아질 때만 불꽃을 피우는 법이다 (벨).",
"행운은 자주 문을 두드리나 미련한 자는 그것을 받아들이지 않는다 (덴마크 속담).",
...
"죄는 미워하고, 죄수는 사랑하라 (마하트마 간디).",
"나는 한 가지 책임만 아는데, 그것은 사랑하는 것이다 (알베르 카뮈).",
"사랑의 고통은 다른 어떠한 즐거움보다 달콤하다 (존 드라이든).",
"사랑은 여자의 섬세함을 줄이고, 남자의 섬세함을 늘인다 (장 파울).",
"사랑하면서 바보가 되지 않는 사람은, 결코 사랑하면서 현명해 질 수 없다 (T. 라이크).",
"사랑은, 배우지 않은 사람에게 문학을 가르친다 (에우리피데스).",
"사랑은 나이들어 생기 없는 사람들을 젊게 만들며, 젊음을 찾는 사람들을 언제까지나 젊게 만든다 (W. 카트라이트).",
"사랑은 사람들을 재주꾼으로 만든다 (몰리에르).",
